<?php namespace Wordplan\Admin\Forms;
...
class InlineForm extends FormAbstract
{
	...
	public function outputForm()
	{
		...
		wordplan()->views()->getView('inline_form.php', $args);
	}
	...
	public function save()
	{
        ...
        $data_key = '_wordplan-admin-nonce-' . $this->getId();
		...
		if(empty($post_data) || !wp_verify_nonce($_POST[$data_key], 'wordplan-admin-' . $this->getId() . '-save'))
		{
