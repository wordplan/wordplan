<?php namespace Wordplan\Extensions\Abstracts;
...
abstract class ExtensionAbstract implements ExtensionContract
{
	...
	public function getMeta($name, $default_value = '')
	{
		...
		throw new RuntimeException(__('Meta value by name is not available.', 'wordplan'));
	}
	...
	public function loadMetaByPlugin($file, $locale = '')
	{
		...
		[
			...
			'RequiresWORDPLAN' => 'Requires WORDPLAN',
			'TestedWORDPLAN' => 'WORDPLAN tested up to',
		];
		...
		$this->setMeta('version_wordplan_min', $plugin_data['RequiresWORDPLAN']);
		$this->setMeta('version_wordplan_max', $plugin_data['TestedWORDPLAN']);
